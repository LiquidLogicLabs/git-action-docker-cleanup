...
exports.GenericOCIProvider = void 0;
 ...
 */
class GenericOCIProvider extends base_1.BaseProvider {
    token;
    username;
    password;
    ...
    async authenticate() {
        ...
        try {
            ...
            if (errorMsg.includes('401') || errorMsg.includes('Unauthorized')) {
                throw new types_1.AuthenticationError('OCI registry authentication failed: Invalid credentials. Please check your token or username/password.', 'oci');
            }
            throw new types_1.AuthenticationError(`OCI registry authentication failed: ${errorMsg}`, 'oci');
        }
    }
    async listPackages() {
...
exports.GenericOCIProvider = GenericOCIProvider;
//# sourceMappingURL=generic-oci.js.map